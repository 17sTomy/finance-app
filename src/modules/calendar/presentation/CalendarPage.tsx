...
import { clampDayToMonth } from '../../../shared/utils/dates';
...
export function CalendarPage() {
  ...
  const validSelectedDay = clampDayToMonth(selectedMonth, selectedDay);
  if (selectedDay !== validSelectedDay) setSelectedDay(validSelectedDay);
  const selectedEvents = events.filter((item) => Number(item.date.slice(8, 10)) === validSelectedDay);
  return <>
